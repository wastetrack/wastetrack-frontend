                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5" method="post" action="#">
                            ...
                            <div>
                                ...
                                <div className="text-right pt-1 sm:pt-2">
                                    <Link href="/forgot-password" className="text-xs sm:text-sm font-medium text-emerald-600 hover:text-emerald-700 transition-colors">
                                        Lupa Password?
                                    </Link>
                                </div>
                            </div>
                            ...
                            <p className="text-xs sm:text-sm text-center text-gray-700">
                                Belum punya akun?{' '}
                                <Link href="/register" className="text-xs sm:text-sm font-semibold text-emerald-600 hover:text-emerald-700 transition-colors">
                                    Daftar
                                </Link>
                            </p>
                        </form>
