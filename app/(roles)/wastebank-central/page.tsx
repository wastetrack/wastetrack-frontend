...
export default function DashboardPage() {
  ...
  const dashboardData = {
    ...
    recentTransactions: [
      ...
      {
        id: 3,
        customer: 'PT Recycle Indo',
        amount: 5200000,
        type: 'Penjualan Offtaker',
        time: '11:00',
      },
    ],
  };
      ...
      <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between'>
        <div>
          <h1 className='flex items-center gap-2 text-2xl font-bold text-gray-900'>
            ...
            Dashboard Bank Sampah Pusat
          </h1>
          <p className='mt-1 text-gray-600'>
            Kelola operasional pusat koordinasi bank sampah regional
          </p>
        </div>
      ...
      <div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4'>
        <div className='rounded-lg border border-gray-200 bg-white p-6 shadow-sm'>
          ...
          <div className='mt-4 flex items-center text-sm'>
            ...
            <span className='text-green-600'>+5 bulan ini</span>
          </div>
        </div>
        ...
        <div className='rounded-lg border border-gray-200 bg-white p-6 shadow-sm'>
          ...
          <div className='mt-4 flex items-center text-sm'>
            <TrendingUp className='mr-1 text-green-500' size={16} />
            <span className='text-green-600'>+22% dari kemarin</span>
          </div>
        </div>
        ...
        <div className='rounded-lg border border-gray-200 bg-white p-6 shadow-sm'>
          ...
          <div className='mt-4 flex items-center text-sm'>
            <TrendingUp className='mr-1 text-green-500' size={16} />
            <span className='text-green-600'>+18% dari bulan lalu</span>
          </div>
        </div>
        ...
        <div className='rounded-lg border border-gray-200 bg-white p-6 shadow-sm'>
          ...
          <div className='mt-4 flex items-center text-sm'>
            ...
            <span className='text-yellow-600'>8 item menipis</span>
          </div>
        </div>
      </div>
          ...
          <div className='flex items-center'>
            ...
            <div>
              <p className='text-sm font-medium text-yellow-800'>
                Anda memiliki {dashboardData.pendingRequests} permintaan
                offtaker yang perlu diproses
              </p>
              <p className='mt-1 text-sm text-yellow-700'>
                Klik untuk melihat detail permintaan dari industri offtaker
              </p>
            </div>
          </div>
        </div>
